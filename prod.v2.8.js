...
var xv = (zi, si, on) =>
  si in zi
    ? wv(zi, si, { enumerable: !0, configurable: !0, writable: !0, value: on })
    : (zi[si] = on);
var W = (zi, si, on) => xv(zi, typeof si != "symbol" ? si + "" : si, on);
(function () {
  "use strict";
          ...
          if (
            ...
            (P.setPositions = function (F, K, j, J) {
              ...
              P.refresh(
                ...
                !1,
                {
                  start: zu(F, j && !!P._startClamp),
                  end: zu(K, j && !!P._endClamp),
                },
                J
              ),
                P.update();
...
` &&
    ...
    Xg = (t, e, i, n, r, s) => {
      ...
      e === "fade"
        ? a.fromTo(
            t,
            { opacity: 0 },
            { opacity: 1, duration: i, delay: n, ease: r }
          )
        : e === "move-up" &&
          a.fromTo(
            t,
            { opacity: 0, y: 50 },
            { opacity: 1, y: 0, duration: i, delay: n, ease: r }
          );
    },
    Qi = () => {
      Gg();
  ...
  new ((function (t) {
    function e() {
      var n;
      return (
        ((n = t.call(this) || this).logger = new mv("@barba/core")),
        (n.all = [
          "ready",
          "page",
          "reset",
        ...
        if (this.registered.has(n)) {
          ...
          return (
            this.registered.get(n).forEach(function (o) {
              a = a.then(function () {
                return vv(o.fn, o.ctx).apply(void 0, [].slice.call(r, 1));
              });
            }),
            a.catch(function (o) {
  ...
  const rf = (t, e) => {
    ...
    _v = () => {
      window.addEventListener("resize", yv),
        window.addEventListener("orientationchange", bv);
