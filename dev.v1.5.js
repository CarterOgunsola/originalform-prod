...
var B = (Ue, ze, ie) => _l(Ue, typeof ze != "symbol" ? ze + "" : ze, ie);
var wa = (Ue, ze, ie) =>
  new Promise((ys, sn) => {
    var bs = (qt) => {
        try {
...
*/ (function (n, r, i) {
  ...
  function kp({ swiper: e, extendParams: t, on: n, emit: r }) {
    ...
    function x($) {
      ...
      k.touch
        ? (I[W](T.start, y, R), I[W](T.move, v, R), I[W](T.end, b, M))
        : (I[W](O.start, y, R), i[W](O.move, v, R), i[W](O.end, b, M));
    }
    function S() {
  ...
  function $p({ swiper: e, extendParams: t, on: n, emit: r }) {
    ...
    function w(k) {
      ...
      let R, M, W, K, se, le, fe, ge, _e, Ye, Fe, Zt, De, He, ee, pe, Xe, Ze;
...
In order to be iterable, non-array objects must have a [Symbol.iterator]() method.`);
  ...
  const bv = (e) => {
    const t = document.querySelectorAll("[page-load='component']"),
      ...
      s = new Pe(i, { type: "lines", linesClass: "pg-load-text-line" });
    s.lines.forEach((o) => {
  ...
  const _v = (e) => {
    ...
    xf = () => {
      console.log("homeInit"), xd(), Jp(), $r(), Or();
      const e = bv();
