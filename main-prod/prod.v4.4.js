...
*/ (function (i, n, r) {
   ...
   */ var Pt = {
    ...
    fn = function (e) {
      return e._gsap || io(qt(e))[0]._gsap;
    },
    yc = function (e, i, n) {
      return (n = e[i]) && ke(n)
        ? e[i]()
    ...
    Vm = function (e) {
      ...
      return n && i.length > 1 && n.config
        ? n.config.apply(
            null,
            ~e.indexOf("{") ? [Hm(i[1])] : qm(e).split(",").map(_c)
          )
        : Qe._CE && Bm.test(e)
        ? Qe._CE("", e)
        : n;
  ...
  var Ym = function (e, i, n, r, s, a, o) {
    ...
    mo = function t(e, i, n) {
      ...
      if (
        ...
        (e._yEase = d ? Vc(pn(d === !0 ? s : d, Gn.ease)) : 0),
        d &&
          e._yoyo &&
          !e._repeat &&
  ...
  var Be = (function (t) {
    ...
    function e(n, r, s, a) {
      ...
      var l = o.vars,
        ...
        y = l.yoyoEase,
        v = r.parent || xe,
        b = (tt(n) || cc(n) ? xi(n[0]) : "length" in r) ? [n] : qt(n),
        w,
        x,
        E,
        C,
      ...
      return (
        h === !0 && !Va && ((qi = wi(o)), xe.killTweensOf(b), (qi = 0)),
        ci(v, wi(o), s),
      ...
      return (
        ...
        C !== Hr &&
          ...
          n.svg &&
            ...
            (n.forceCSS = e.setAttribute("transform", "") || !yu(Vt(e, Se))),
  ...
  var Me = (function () {
    ...
    return (
      (e.init = function (n) {
        Fs || Mu(nt) || console.warn("Please gsap.registerPlugin(Observer)"),
          Yr || Pu();
        var r = n.tolerance,
          s = n.dragMinimum,
          a = n.type,
   ...
   */ var H,
    ...
    ia = function (e, i, n, r, s, a, o, l) {
      ...
      return (
        ...
        (g || l || !p) &&
          (w += (r === qe ? Wo : Go) + ":" + (a + parseFloat(f)) + "px;"),
        o &&
          (w +=
    ...
    j = (function () {
      ...
      return (
              ...
              if (!((rt || !P.enabled) && !K)) {
                ...
                if (
                  ...
                  (Je = Gt(h)),
                    ...
                    L &&
                      ((ut = {
                        top: ct.top + (Pa ? Hn - Y : Dl) + Ve,
                        left: ct.left + (Pa ? Dl : Hn - Y) + Ve,
                        boxSizing: "border-box",
                        position: "fixed",
                      }),
                      (ut[En] = ut["max" + ur] = Math.ceil(ct.width) + Ve),
                      (ut[Cn] = ut["max" + Xo] = Math.ceil(ct.height) + Ve),
                      (ut[Wt] =
                        ut[Wt + ns] =
                        ut[Wt + ts] =
                        ut[Wt + rs] =
        ...
        (t.config = function (n) {
          "limitCallbacks" in n && (qo = !!n.limitCallbacks);
...
` &&
  ...
  const yd = class df {
    ...
    split(e) {
      ...
      return (
        ...
        hr &&
          (o
            ? hr.addEventListener("loadingdone", this._split)
            : hr.status === "loading" &&
  ...
  const Qg = (t) => {
    ...
    Ki = () => {
      document.querySelectorAll("[motion]").forEach((e) => Qg(e));
    };
  R.registerPlugin(ye);
  const Kg = (t) => {
  ...
  const Jg = (t) => {
    ...
    bd = () => {
      console.log("homeInit"), If(), ac(), Qi(), Ki(), t0();
      const t = Kg();
   ...
   */ var q0 = 1,
    ...
    fs = function (e) {
      return mr(e)[0] || console.warn("Element not found:", e);
    },
    gr = function (e) {
    ...
    U0 = function (e) {
      ...
      return i || e.setAttribute("data-flip-id", (i = "auto-" + q0++)), i;
    },
    Jd = function (e) {
      ...
      return (
        k || !c
          ...
          : ((S = W0(c)),
            ...
            (g = gr(Math.atan2(O.b, O.a) * Vd)),
            ($ = gr(Math.atan2(O.c, O.d) * Vd + g) % 360),
      ...
      if (
        ...
        (Ee = function () {
          ...
          Xt &&
            ...
            M.call(function () {
              var V = M.time() >= oe;
              V && !Xt && Ud(L, !a), y && xl(ze, y, V ? "remove" : "add");
            });
        }),
        u &&
