...
*/ (function (i, n, r) {
   ...
   */ var Pt = {
        ...
        function (i) {
          ...
          return qt(
            ...
            n.querySelectorAll
              ? n
              : n === e
              ? Mr("Invalid scope") || Ka.createElement("div")
              : e
          );
        }
      );
    ...
    Dr = function (e) {
      for (var i = 0, n = "", r, s, a, o; ~(r = e.indexOf("random(", i)); )
        (a = e.indexOf(")", r)),
          (o = e.charAt(r + 7) === "["),
          (s = e.substr(r + 7, a - r - 7).match(o ? vc : Ua)),
          (n +=
            e.substr(i, r - i) +
    ...
    Yc = function (e, i, n) {
      ...
      if (!r) {
        ...
        } else r = e.match(Ua) || Rr.transparent;
        r = r.map(Number);
      }
      return (
        i &&
  ...
  var Zm = function (e, i, n, r, s, a, o) {
    ...
    Jc = no + "repeat,repeatDelay,yoyo,repeatRefresh,yoyoEase,autoRevert",
    eu = {};
  ...
  var yo = function (e, i, n) {
    ...
    bo = function (e, i) {
      return ke(e[i]) ? tu : Xa(e[i]) && e.setAttribute ? ig : yo;
    },
    iu = function (e, i) {
  ...
  (Be.version = ht.version = Tt.version = "3.13.0"), (yc = 1), ja() && Jn();
  /*!
   * CSSPlugin 3.13.0
   * https://gsap.com
   *
  ...
  var Me = (function () {
    ...
    return (
      (e.init = function (n) {
        ...
        (fe = I._dc = nt.delayedCall(f || 0.25, Ma).pause()),
          (I.deltaX = I.deltaY = 0),
          (I._vx = Do(0, 50, !0)),
          (I._vy = Do(0, 50, !0)),
          (I.scrollX = V),
   ...
   */ var H,
    ...
    Uu = function (e) {
      return (
        ...
        (Sn(e)
          ? function () {
              return (oa.width = se.innerWidth), (oa.height = qo), oa;
            }
          : function () {
              return Ci(e);
            })
          ...
          if (
            ...
            (P.refresh = function (F, K, X, J) {
              if (!((rt || !P.enabled) && !K)) {
                ...
                for (
                  D &&
                  Tn(X) &&
                  ((vs = H.getProperty(I, T.p)), (Oa = H.getProperty(ze, T.p)));
                  Ke-- > 0;
                ...
                if (
                  ...
                  (Je = Gt(h)),
                    ...
                    L &&
                      ((ut = {
                        top: ct.top + ($a ? Hn - Y : Fl) + Ve,
                        left: ct.left + ($a ? Fl : Hn - Y) + Ve,
            ...
            (P.setPositions = function (F, K, X, J) {
              ...
              P.refresh(
                ...
                !1,
                {
                  start: Vu(F, X && !!P._startClamp),
                  end: Vu(K, X && !!P._endClamp),
                },
                J
              ),
                P.update();
...
` &&
  ...
  const Sd = class vf {
    ...
    static register(e) {
      (ls = ls || e || window.gsap),
        ls && ((ua = ls.utils.toArray), (al = ls.core.context || al)),
  ...
  const cl = (t) => {
    ...
    ul = (t) => {
      (Math.abs(t - ll) > 150 || !da()) && ((ll = t), (Td = t));
    },
    dl = () => {
      const t = navigator.userAgent,
  ...
  const fa = () => {
    ...
    Ki = () => {
      ...
      document.readyState === "interactive"
        ? fa()
        : window.addEventListener("DOMContentLoaded", fa);
      let t;
      const e = () => {
        clearTimeout(t),
          (t = setTimeout(() => {
            dl() || cl(window.innerHeight) || fa();
          }, 150));
      };
      return (
        ...
        () => {
          window.removeEventListener("resize", e),
            window.removeEventListener("DOMContentLoaded", fa),
            Ed();
        }
      );
    };
  ...
  const T0 = () => {
      "ontouchstart" in window ||
        navigator.maxTouchPoints > 0 ||
        ((ha = new S0({ autoRaf: !0, smoothWheel: !0, smoothTouch: !1 })),
   ...
   */ var pi,
    ...
    Yd = function () {
      Rd() &&
        ...
        (Ld = ((pa.navigator || {}).userAgent || "").indexOf("Edge") !== -1));
    },
    vl = {
      version: "3.13.0",
      name: "drawSVG",
   ...
   */ var Pi,
    ...
    wl = function () {
      return (
        zn.pageYOffset || Pi.scrollTop || yl.scrollTop || ya.scrollTop || 0
      );
    },
    xl = function () {
      return (
        zn.pageXOffset || Pi.scrollLeft || yl.scrollLeft || ya.scrollLeft || 0
      );
    },
    Sl = function (e) {
      return (
    ...
    j0 = function (e, i) {
      ...
      if (e === zn) return e;
      if (
        (s.length || s.push(Tl(e, 1), Tl(e, 2), Tl(e, 3)), (l = n ? ba : cs), n)
      )
        r
          ? ((u = jd(e)), (d = -u.e / u.a), (f = -u.f / u.d), (c = _a))
          : e.getBBox
          ? ((u = e.getBBox()),
   ...
   */ var U0 = 1,
    ...
    Ol = function (e, i, n) {
      ...
      if (
        ...
        d = new In(r);
      else if (((d = vr(e, wa)), (d.position = "absolute"), e.simple)) {
    ...
    Rl = function (e, i, n, r) {
      ...
      if (
        ...
        (L.finalStates = Te = []),
        (Ee = function () {
          for (Ta(L), uf(!0), ne = 0; ne < L.length; ne++)
            (Q = L[ne]),
              (Y = Q.a),
              (te = Q.b),
    ...
    Kt = (function () {
      function t(i, n, r) {
        if (((this.props = n && n.props), (this.simple = !!(n && n.simple)), r))
          (this.targets = of(i)), (this.elementStates = i), ka(this);
        else {
          this.targets = mr(i);
      ...
      return (
        ...
        (e.makeAbsolute = function () {
          return Ta(this.elementStates.slice(0), !0, !0).map(Ol);
        }),
        t
      );
    })(),
