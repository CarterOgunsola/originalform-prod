...
var Mv = (zi, si, on) =>
  si in zi
    ? Pv(zi, si, { enumerable: !0, configurable: !0, writable: !0, value: on })
    : (zi[si] = on);
var W = (zi, si, on) => Mv(zi, typeof si != "symbol" ? si + "" : si, on);
(function () {
  "use strict";
...
` &&
  ...
  var g0 = class {
    ...
    advance(t) {
      ...
      if (this.duration && this.easing) {
        ...
        this.lerp
          ? ((this.value = p0(this.value, this.to, this.lerp * 60, t)),
  ...
  var y0 = class {
      constructor(t, e, { autoResize: i = !0, debounce: n = 250 } = {}) {
        ...
        (this.wrapper = t),
          (this.content = e),
          i &&
            ((this.debouncedResize = v0(this.resize, n)),
            this.wrapper instanceof Window
    ...
    _0 = class {
      constructor({
        ...
        (window.lenisVersion = f0),
          ...
          (this.dimensions = new y0(t, e, { autoResize: p })),
      ...
      get scroll() {
        return this.options.infinite
          ? m0(this.animatedScroll, this.limit)
          : this.animatedScroll;
      }
      get progress() {
  ...
  const w0 = () => {
      "ontouchstart" in window ||
        navigator.maxTouchPoints > 0 ||
        ((da = new _0({ autoRaf: !0, smoothWheel: !0, smoothTouch: !1 })),
   ...
   */ var pi,
    ...
    ma = function (e) {
      ...
      if (
        ...
        for (
          l = e.getAttribute("points").match(L0) || [],
   ...
   */ var G0 = 1,
    ...
    j0 = El("onStart,onUpdate,onComplete,onReverseComplete,onInterrupt"),
    wa = El(
    ...
    xa = function (e, i, n) {
      return (
        e.forEach(function (r) {
          return (r.d = Z0(n ? r.element : r.t, i));
        }),
        e.sort(function (r, s) {
          return r.d - s.d;
        }),
    ...
    J0 = function (e) {
      ...
      return i || e.setAttribute("data-flip-id", (i = "auto-" + G0++)), i;
    },
    rf = function (e) {
    ...
    Dl = function (e, i, n) {
      if (e && e.progress() < 1 && (!e.paused() || n))
        return i && (ev(e), i < 2 && e.progress(1), e.kill()), !0;
    },
    Ea = function (e) {
      for (
        var i = (e.idLookup = {}),
    ...
    iv = (function () {
      ...
      return (
        (e.add = function (n) {
          ...
          return r.length
            ? r[0]
            : ((r = new tv(typeof n == "function" ? { animate: n } : n, this)),
              this.actions.push(r),
              r);
        }),
        (e.remove = function (n) {
    ...
    yr = (function () {
      ...
      return (
        ...
        (t.batch = function (i) {
          return i || (i = "default"), Tl[i] || (Tl[i] = new iv(i));
        }),
  ...
  const gv = (t) => {
    ...
    vv = (t = !0) => {
      document.fonts.ready.then(() => {
        t ? lf() : cf(), window.addEventListener("resize", () => gv(t));
      });
    },
    yv = () => {
