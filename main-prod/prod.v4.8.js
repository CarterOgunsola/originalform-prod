...
var vv = (zi, si, on) =>
  si in zi
    ? gv(zi, si, { enumerable: !0, configurable: !0, writable: !0, value: on })
    : (zi[si] = on);
var W = (zi, si, on) => vv(zi, typeof si != "symbol" ? si + "" : si, on);
(function () {
  "use strict";
            ...
            (P.refresh = function (F, K, j, J) {
              if (!((rt || !P.enabled) && !K)) {
                ...
                for (
                  I &&
                  Sn(j) &&
                  ((gs = H.getProperty(D, T.p)), (ka = H.getProperty(ze, T.p)));
                  Ke-- > 0;
...
` &&
   ...
   */ var z0 = 1,
    ...
    H0 = function (e) {
      ...
      return i || e.setAttribute("data-flip-id", (i = "auto-" + z0++)), i;
    },
    Zd = function (e) {
