...
var bv = (zi, si, on) =>
  si in zi
    ? yv(zi, si, { enumerable: !0, configurable: !0, writable: !0, value: on })
    : (zi[si] = on);
var W = (zi, si, on) => bv(zi, typeof si != "symbol" ? si + "" : si, on);
(function () {
  "use strict";
...
*/ (function (i, n, r) {
  ...
  Object.keys(Ia).forEach((t) => {
    Object.keys(Ia[t]).forEach((e) => {
      ft.prototype[e] = Ia[t][e];
    });
  }),
    ft.use([Eh, Ch]);
   ...
   */ var Pt = {
    ...
    Ic = function (e, i, n) {
      ...
      if (!r) {
        ...
        } else r = e.match(Ya) || Ir.transparent;
        r = r.map(Number);
      }
      return (
        i &&
    ...
    Rm = function (e) {
      ...
      return n && i.length > 1 && n.config
        ? n.config.apply(
            null,
            ~e.indexOf("{") ? [Dm(i[1])] : Im(e).split(",").map(vc)
          )
        : Qe._CE && Lm.test(e)
        ? Qe._CE("", e)
        : n;
  ...
  var ht = (function (t) {
    ...
    return (
      ...
      (i.nextLabel = function (r) {
        return r === void 0 && (r = this._time), Lc(this, Ht(this, r));
      }),
      (i.previousLabel = function (r) {
        return r === void 0 && (r = this._time), Lc(this, Ht(this, r), 1);
      }),
          ...
          if (
            ...
            for (C in x)
              $t[C] && (S = Yc(C, x, e, L, $, v))
                ? S.priority && (T = 1)
                : (O[C] = k =
                    co.call(e, $, C, "get", x[C], L, v, 0, r.stringFilter));
  ...
  var Be = (function (t) {
    ...
    function e(n, r, s, a) {
      ...
      return (
        h === !0 && !Fa && ((Hi = wi(o)), xe.killTweensOf(b), (Hi = 0)),
        ci(v, wi(o), s),
      ...
      (i.render = function (r, s, a) {
        ...
        if (!c) wm(this, r, s, a);
          ...
          (b && b.render(r < 0 ? r : b._dur * b._ease(f / this._dur), s, a)) ||
            ...
            this._onUpdate &&
              !s &&
              (u && to(this, r, s, a), Lt(this, "onUpdate")),
            this._repeat &&
              m !== g &&
              this.vars.onRepeat &&
              !s &&
    ...
    Hr = function (e, i) {
      ...
      return (
        ...
        n.svg &&
          ...
          Co(e, z || c, !!z || n.originIsAbsolute, n.smooth !== !1, C)),
        (x = n.xOrigin || 0),
        (E = n.yOrigin || 0),
        C !== Fr &&
          ((M = C[0]),
    ...
    return (
      (e.init = function (n) {
        ...
        var $e,
            ...
            if (!He(j)) {
              ...
              var ce =
                (j.deltaMode === 1
                  ...
                  ? Dt.innerHeight
                  : 1) * m;
              br(j.deltaX * ce, j.deltaY * ce, 0), d && !D && fe.restart(!0);
            }
          },
          Bn = function (j) {
            if (!He(j)) {
          ...
          ps = function (j) {
            return He(j) || (Gr(j, u) && ne(I));
          };
        (fe = I._dc = nt.delayedCall(f || 0.25, Ea).pause()),
          (I.deltaX = I.deltaY = 0),
          (I._vx = Mo(0, 50, !0)),
          (I._vy = Mo(0, 50, !0)),
          (I.scrollX = V),
   ...
   */ var H,
    ...
    Bu = function () {
      return H || (Nu() && (H = window.gsap) && H.registerPlugin && H);
    },
    xn = function (e) {
      return !!~$o.indexOf(e);
    },
    ...
    ta = function (e, i, n, r, s, a, o, l) {
      ...
      return (
        ...
        (g || l || !p) &&
          (w += (r === qe ? qo : Vo) + ":" + (a + parseFloat(f)) + "px;"),
        o &&
          (w +=
    ...
    Zu = function (e, i) {
      re.cache++,
        ...
        Rt(e) && (se.history.scrollRestoration = Io = e);
    },
    bt,
    An = 0,
    Qu,
          ...
          if (
            ...
            (P.refresh = function (F, K, X, J) {
              if (!((rt || !P.enabled) && !K)) {
                ...
                for (
                  D &&
                  Sn(X) &&
                  ((gs = H.getProperty(I, T.p)), (ka = H.getProperty(ze, T.p)));
                  Ke-- > 0;
            ...
            (P.setPositions = function (F, K, X, J) {
              ...
              P.refresh(
                ...
                !1,
                {
                  start: Du(F, X && !!P._startClamp),
                  end: Du(K, X && !!P._endClamp),
                },
                J
              ),
                P.update();
        ...
        (t.enable = function () {
          if (
            ...
            H &&
              ((Xr = H.utils.toArray),
              (jr = H.utils.clamp),
              (Do = H.core.context || fi),
              (Lo = H.core.suppressOverwrites || fi),
              (Io = se.history.scrollRestoration || "auto"),
              (Uo = se.pageYOffset || 0),
        ...
        (t.config = function (n) {
          ...
          (r && clearInterval(Ys)) || ((Ys = r) && setInterval(Xu, r)),
            "ignoreMobileResize" in n &&
              (zo = t.isTouch === 1 && n.ignoreMobileResize),
  ...
  (U.version = "3.13.0"),
    ...
    (U.refresh = function (t) {
      return t ? ss(!0) : (sr || U.register()) && Pn(!0);
    }),
    (U.update = function (t) {
      return ++re.cache && ki(t === !0 ? 2 : 0);
    }),
    (U.clearScrollMemory = Zu),
...
` &&
  ...
  const Wg = (t) => {
    ...
    Qi = () => {
      document.querySelectorAll("[motion]").forEach((e) => Wg(e));
    };
  R.registerPlugin(_e);
  const Gg = (t) => {
  ...
  const Xg = (t) => {
    ...
    gd = () => {
      console.log("homeInit"), Mf(), nc(), Zi(), Qi(), Ug();
      const t = Gg();
      t.add(() => Ki(), "-=0.8"), t.add(() => Xg(), "-=0.8");
    },
    vd = () => {
  ...
  var a0 = class {
    ...
    advance(t) {
      ...
      if (this.duration && this.easing) {
        ...
        this.lerp
          ? ((this.value = r0(this.value, this.to, this.lerp * 60, t)),
  ...
  var l0 = class {
      constructor(t, e, { autoResize: i = !0, debounce: n = 250 } = {}) {
        ...
        (this.wrapper = t),
          (this.content = e),
          i &&
            ((this.debouncedResize = o0(this.resize, n)),
            this.wrapper instanceof Window
    ...
    u0 = class {
      constructor({
        ...
        (window.lenisVersion = i0),
          ...
          (this.dimensions = new l0(t, e, { autoResize: p })),
      ...
      get scroll() {
        return this.options.infinite
          ? s0(this.animatedScroll, this.limit)
          : this.animatedScroll;
      }
      get progress() {
  ...
  const d0 = () => {
      "ontouchstart" in window ||
        navigator.maxTouchPoints > 0 ||
        ((ua = new u0({ autoRaf: !0, smoothWheel: !0, smoothTouch: !1 })),
   ...
   */ var Pi,
    ...
    dl = function () {
      return (
        Ln.pageYOffset || Pi.scrollTop || ll.scrollTop || ma.scrollTop || 0
      );
    },
    fl = function () {
      return (
        Ln.pageXOffset || Pi.scrollLeft || ll.scrollLeft || ma.scrollLeft || 0
      );
    },
    hl = function (e) {
      return (
   ...
   */ var I0 = 1,
    ...
    N0 = yl("onStart,onUpdate,onComplete,onReverseComplete,onInterrupt"),
    _a = yl(
    ...
    wa = function (e, i, n) {
      return (
        e.forEach(function (r) {
          return (r.d = F0(n ? r.element : r.t, i));
        }),
        e.sort(function (r, s) {
          return r.d - s.d;
        }),
    ...
    xl = function (e, i, n) {
      ...
      if (
        ...
        d.matrix = new zn(1, 0, 0, 1, m.left + fl(), m.top + dl());
    ...
    V0 = function (e) {
      ...
      return i || e.setAttribute("data-flip-id", (i = "auto-" + I0++)), i;
    },
    Zd = function (e) {
    ...
    kl = function (e, i, n, r) {
      ...
      if (
        ...
        (L.finalStates = Te = []),
        (Ee = function () {
          for (wa(L), Jd(!0), ne = 0; ne < L.length; ne++)
            (Q = L[ne]),
              (Y = Q.a),
              (te = Q.b),
          ...
          (he.length || O.length || S.length) &&
            (y &&
              M.add(function () {
                return bl(ze, y, M._zTime < 0 ? "remove" : "add");
              }, 0) &&
              !h &&
              bl(ze, y, "add"),
          ...
          Xt &&
            ...
            M.call(function () {
              var V = M.time() >= oe;
              V && !Xt && Gd(L, !a), y && bl(ze, y, V ? "remove" : "add");
            });
        }),
        u &&
        ...
        var Oe;
        c && (Oe = ye._abs).push.apply(Oe, Xd(L, c)), ye._run.push(Ee);
      } else c && jd(Xd(L, c)), Ee();
      var Le = ye ? ye.timeline : M;
      return (
        (Le.revert = function () {
          return Al(Le, 1, 1);
        }),
    ...
    Al = function (e, i, n) {
      if (e && e.progress() < 1 && (!e.paused() || n))
        return i && (Y0(e), i < 2 && e.progress(1), e.kill()), !0;
    },
    Ta = function (e) {
      for (
        var i = (e.idLookup = {}),
        ...
        (e.update = function (n, r) {
          var s = this,
            ...
            u =
              ...
              a.getBBox(),
            d = r
              ? new zn(1, 0, 0, 1, c.left + fl(), c.top + dl())
              : mi(a, !1, !1, !0);
          (l.uncache = 1),
            (s.getProp = o),
            (s.element = a),
    ...
    G0 = (function () {
      ...
      return (
        (e.add = function (n) {
          ...
          return r.length
            ? r[0]
            : ((r = new W0(typeof n == "function" ? { animate: n } : n, this)),
              this.actions.push(r),
              r);
        }),
        (e.remove = function (n) {
    ...
    yr = (function () {
      ...
      return (
        ...
        (t.batch = function (i) {
          return i || (i = "default"), vl[i] || (vl[i] = new G0(i));
        }),
        ...
        _e.create(t, {
          ...
          onSplit: function (n) {
            ...
            return R.from(r, {
              ...
              stagger: s.stagger,
              ease: "expo.out",
              scrollTrigger: { trigger: t, start: "clamp(top 80%)", once: !0 },
            });
          },
        });
      });
  ...
  new ((function (t) {
    function e() {
      var n;
      return (
        ((n = t.call(this) || this).logger = new dv("@barba/core")),
        (n.all = [
          "ready",
          "page",
          "reset",
  ...
  const $l = (t) => {
    ...
    mv = nf(() => {
      ...
      $l(t);
      const e = $n();
      e && e.resize(), U.refresh();
    }, 250),
    gv = () => {
      setTimeout(() => {
        const t = $n();
        t && t.resize(), U.refresh();
      }, 500);
    },
    vv = () => {
      pv(),
      ...
      const i = nf(() => {
        ...
        if (r || s) {
          $l(n);
          const a = $n();
          a && a.resize(), U.refresh(), (t = n), (e = window.innerWidth);
        }
      }, 100);
