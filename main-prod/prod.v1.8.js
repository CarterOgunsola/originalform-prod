...
*/ (function (i, n, r) {
  ...
  function Ep() {
    ...
    (t.onTouchStart = bp.bind(t)),
      ...
      (t.onClick = xp.bind(t)),
      n.touch && !rc && (e.addEventListener("touchstart", Tp), (rc = !0)),
      sc(t, "on");
  }
  function Cp() {
    sc(this, "off");
   ...
   */ var Pt = {
    ...
    zr = function (e) {
      for (var i = 0, n = "", r, s, a, o; ~(r = e.indexOf("random(", i)); )
        (a = e.indexOf(")", r)),
          (o = e.charAt(r + 7) === "["),
          (s = e.substr(r + 7, a - r - 7).match(o ? pc : Ga)),
          (n +=
            e.substr(i, r - i) +
            Dc(o ? s : +s[0], o ? 0 : +s[1], +s[2] || 1e-5)),
          (i = a + 1);
      ...
      if (e)
        if (((e = (!e.name && e.default) || e), Wa() || e.headless)) {
          ...
          if ((Kn(), e !== r)) {
            if ($t[i]) return;
            Ot(r, Ot($s(e, s), a)),
              jn(r.prototype, jn(s, $s(e, a))),
              ($t[(r.prop = i)] = r),
              e.targetTest && (Ps.push(r), (Qa[i] = 1)),
              (i =
                (i === "css"
                  ? "CSS"
          ...
          wake: function () {
            mc &&
              (!ja &&
                ...
                gc(ks || li.GreenSockGlobals || (!li.gsap && li) || {}),
                Bc.forEach(Fc)),
    ...
    Gm = function (e) {
      ...
      return n && i.length > 1 && n.config
        ? n.config.apply(
            null,
            ~e.indexOf("{") ? [Ym(i[1])] : Wm(e).split(",").map(xc)
          )
        : Qe._CE && Vm.test(e)
        ? Qe._CE("", e)
        : n;
  ...
  var ht = (function (t) {
    ...
    return (
      ...
      (e.updateRoot = function (r) {
        if ((xe._ts && (wc(xe, Ls(r, xe)), (yc = zt.frame)), zt.frame >= bc)) {
          bc += Pt.autoSleep || 120;
          var s = xe._first;
  ...
  var Xm = function (e, i, n, r, s, a, o) {
    ...
    po = function t(e, i, n) {
      ...
      if (
        ...
        (e._yEase = d ? Wc(hn(d === !0 ? s : d, Wn.ease)) : 0),
        d &&
          e._yoyo &&
          !e._repeat &&
    ...
    Zc = eo + "repeat,repeatDelay,yoyo,repeatRefresh,yoyoEase,autoRevert",
    Qc = {};
  ...
  var Be = (function (t) {
    ...
    function e(n, r, s, a) {
      ...
      var l = o.vars,
        ...
        y = l.yoyoEase,
        v = r.parent || xe,
        b = (tt(n) || dc(n) ? xi(n[0]) : "length" in r) ? [n] : Vt(n),
        w,
        x,
        E,
        C,
  ...
  var mo = function (e, i, n) {
    ...
    go = function (e, i) {
      return ke(e[i]) ? Kc : Ya(e[i]) && e.setAttribute ? Jm : mo;
    },
    Jc = function (e, i) {
  ...
  var mn = [],
    ...
    Rs = {
      ...
      defaults: function (e) {
        return e && e.ease && (e.ease = hn(e.ease, Wn.ease)), Tc(Wn, e || {});
      },
      config: function (e) {
        return Tc(Pt, e || {});
      },
  ...
  (Be.version = ht.version = Tt.version = "3.13.0"), (mc = 1), Wa() && Kn();
  /*!
   * CSSPlugin 3.13.0
   * https://gsap.com
   *
   ...
   */ var ru,
    ...
    wu = function (e) {
      var i = qt(e, Se);
      return _u(i) ? Fr : i.substr(7).match(fc).map(Pe);
    },
    ko = function (e, i) {
      var n = e._gsap || dn(e),
        r = e.style,
      ...
      return (
        ...
        C !== Fr &&
          ...
          n.svg &&
            ...
            (n.forceCSS = e.setAttribute("transform", "") || !_u(qt(e, Se))),
        ...
        (n.renderTransform = n.svg ? Ag : du ? xu : kg),
        (n.uncache = 0),
        n
      );
    },
   ...
   */ var nt,
    ...
    qs = function (e, i) {
      var n = function r(s) {
        if (s || s === 0) {
          Pu && (Dt.history.scrollRestoration = "manual");
    ...
    gt = {
      ...
      sc: qs(function (t) {
        return arguments.length
          ? Dt.scrollTo(t, Ve.sc())
          : Dt.pageXOffset || Wi[Hs] || Gi[Hs] || nr[Hs] || 0;
      }),
    },
    Ve = {
      s: Vs,
      ...
      sc: qs(function (t) {
        return arguments.length
          ? Dt.scrollTo(gt.sc(), t)
          : Dt.pageYOffset || Wi[Vs] || Gi[Vs] || nr[Vs] || 0;
      }),
    },
    Ct = function (e, i) {
      return (
   ...
   */ var H,
    ...
    Yu = function () {
      return H || (qu() && (H = window.gsap) && H.registerPlugin && H);
    },
    xn = function (e) {
      return !!~Lo.indexOf(e);
    },
    ...
    Gu = function (e) {
      return (
        ...
        (xn(e)
          ? function () {
              return (oa.width = se.innerWidth), (oa.height = Bo), oa;
            }
          : function () {
              return Ci(e);
            })
    ...
    ki = function (e) {
      if (e === 2 || (!bt && !Xs)) {
        ...
        if (
          ...
          bt || (Qo = s),
          r &&
            (Yt && !Gs && n - Yt > 200 && ((Yt = 0), kn("scrollEnd")),
            (Ur = Vo),
            (Vo = n)),
          ra < 0)
        ) {
    ...
    X = (function () {
      ...
      return (
        (e.init = function (n, r) {
          ...
          n = Uu(Rt(n) || Kr(n) || n.nodeType ? { trigger: n } : n, Js);
          var s = n,
            a = s.onUpdate,
            o = s.toggleClass,
            l = s.id,
          ...
          if (
            ...
            "refreshPriority" in n &&
              ((Du = 1), n.refreshPriority === -9999 && (as = P)),
            ...
            (Jt = Sn(D) ? Uu(D, Qu) : Qu),
              ...
              (rn = I["offset" + T.op.d2]);
            var ms = Ct(Xi(_, "content") || _);
            (Oe = this.markerStart = ia("start", l, ms, T, Jt, rn, 0, C)),
              (Le = this.markerEnd = ia("end", l, ms, T, Jt, rn, 0, C)),
          ...
          if (
            ...
            (P.refresh = function (F, K, j, J) {
              if (!((rt || !P.enabled) && !K)) {
                ...
                for (
                  D &&
                  Sn(j) &&
                  ((vs = H.getProperty(I, T.p)), (Pa = H.getProperty(ze, T.p)));
                  Ke-- > 0;
                ...
                if (
                  ...
                  (Je = Gt(h)),
                    ...
                    L &&
                      ((ut = {
                        top: ct.top + (Aa ? Fn - Y : Rl) + qe,
                        left: ct.left + (Aa ? Rl : Fn - Y) + qe,
            ...
            (P.setPositions = function (F, K, j, J) {
              ...
              P.refresh(
                ...
                !1,
                {
                  start: Fu(F, j && !!P._startClamp),
                  end: Fu(K, j && !!P._endClamp),
                },
                J
              ),
                P.update();
        ...
        (t.disable = function (n, r) {
          (Zr = 0),
            ...
            Xe(ue, "touchstart", fi),
            Qs(Xe, ve, "pointerdown,touchstart,mousedown", Hu),
   ...
   */ let os,
    ...
    ua = (t) =>
      typeof t == "string"
        ...
        ? Array.from(t)
        : [t],
    pd = (t) => ua(t).filter((e) => e instanceof HTMLElement),
    il = [],
    nl = function () {},
    Qg = /\s+/g,
    md = new RegExp(
...
` &&
  ...
  const _d = class pf {
    ...
    static register(e) {
      (os = os || e || window.gsap),
        os && ((ua = os.utils.toArray), (nl = os.core.context || nl)),
  ...
  const al = (t) => {
      if (!ls()) return !1;
      const e = Math.abs(t - wd);
      return e > 50 && e < 150;
    },
    ol = (t) => {
      (Math.abs(t - sl) > 150 || !ls()) && ((sl = t), (wd = t));
    },
    Jg = () => {
      if (!ls()) return;
      const t = () => {
        ...
        document.querySelectorAll("[split-text]").forEach((e) => {
          ye.create(e, {
            ...
            onSplit(i) {
              ...
              return (
                ls() && ((s.refreshPriority = -1), (s.fastScrollEnd = !0)),
                R.from(r, {
                  yPercent: 120,
                  opacity: 0,
                  rotateZ: 2,
  ...
  const cl = () => {
    ...
    i0 = (t) => {
      ...
      ls() && ((l.refreshPriority = -1), (l.fastScrollEnd = !0));
      const c = R.to(t, {
        ...o,
        duration: i,
        delay: n,
    ...
    Qi = () => {
      ...
      document.readyState === "interactive"
        ? cl()
        : window.addEventListener("DOMContentLoaded", cl);
      let t;
      const e = () => {
        clearTimeout(t),
          (t = setTimeout(() => {
            al(window.innerHeight) || X.refresh();
          }, 150));
      };
      return (
        ...
        () => {
          window.removeEventListener("resize", e),
            window.removeEventListener("DOMContentLoaded", cl),
            xd();
        }
      );
    };
   ...
   */ var pi,
    ...
    pl = {
      ...
      init: function (e, i, n, r, s) {
        ...
        return (
          (this.styles =
            fl && fl(e, "strokeDashoffset,strokeDasharray,strokeMiterlimit")),
          (this.tween = n),
          (this._style = e.style),
          (this._target = e),
          i + "" == "true"
  ...
  Dd() && pi.registerPlugin(pl), R.registerPlugin(ye, pl);
  const R0 = (t) => {
   ...
   */ var Pi,
    ...
    yl = function () {
      return (
        Ln.pageYOffset || Pi.scrollTop || ml.scrollTop || ga.scrollTop || 0
      );
    },
    bl = function () {
      return (
        Ln.pageXOffset || Pi.scrollLeft || ml.scrollLeft || ga.scrollLeft || 0
      );
    },
    _l = function (e) {
      return (
    ...
    G0 = function (e, i) {
      ...
      if (e === Ln) return e;
      if (
        (s.length || s.push(wl(e, 1), wl(e, 2), wl(e, 3)), (l = n ? va : cs), n)
      )
        r
  ...
  function mi(t, e, i, n) {
    if (!t || !t.parentNode || (Pi || vl(t)).documentElement === t)
      return new zn();
    var r = q0(t),
      s = _l(t),
      a = s ? qd : Yd,
   ...
   */ var X0 = 1,
    ...
    U0 = El("onStart,onUpdate,onComplete,onReverseComplete,onInterrupt"),
    wa = El(
    ...
    Pl = function (e, i, n) {
      ...
      if (
        ...
        d.matrix = new zn(1, 0, 0, 1, m.left + bl(), m.top + yl());
    ...
    tf = function (e) {
      return xa(e, !0).forEach(function (i) {
        return (
          (i.a.isVisible || i.b.isVisible) && Pl(i.sd < 0 ? i.b : i.a, i.b, 1)
        );
      });
    },
    K0 = function (e, i) {
      return (i && e.idLookup[Ml(i).id]) || e.elementStates[0];
    },
    Ml = function (e, i, n, r) {
      return e instanceof Dn
        ...
        : e instanceof Kt
        ? K0(e, r)
        : new Dn(typeof e == "string" ? fs(e) || void 0 : e, i, n);
    },
    J0 = function (e, i) {
      for (
    ...
    vr = function (e, i, n, r, s, a) {
      var o = e.element,
        ...
        g = i.rotation,
        y = i.bounds,
        v = a && Sl && Sl(o, "transform,width,height"),
        b = e,
        w = i.matrix,
        x = w.e,
        E = w.f,
    ...
    Ol = [],
    Ll = "width,height,overflowX,overflowY".split(","),
    Ta,
    of = function (e) {
      if (e !== Ta) {
        var i = en.style,
        ...
        if (e && (n || r)) {
          ...
          for (; s--; )
            Ol[s] ? (i[Ll[s]] = Ol[s]) : i.removeProperty(Qd(Ll[s]));
          Ta = e;
        }
      }
    },
      ...
      if (
        ...
        (Ee = function () {
          ...
          (he.length || O.length || S.length) &&
            (y &&
              M.add(function () {
                return Cl(ze, y, M._zTime < 0 ? "remove" : "add");
              }, 0) &&
              !h &&
              Cl(ze, y, "add"),
          ...
          Xt &&
            ...
            M.call(function () {
              var q = M.time() >= oe;
              q && !Xt && Jd(L, !a), y && Cl(ze, y, q ? "remove" : "add");
            });
        }),
        u &&
    ...
    Kt = (function () {
      ...
      return (
        ...
        (e.makeAbsolute = function () {
          return xa(this.elementStates.slice(0), !0, !0).map(Pl);
        }),
        t
      );
    })(),
        ...
        (e.update = function (n, r) {
          var s = this,
            ...
            u =
              ...
              a.getBBox(),
            d = r
              ? new zn(1, 0, 0, 1, c.left + bl(), c.top + yl())
              : mi(a, !1, !1, !0);
          (l.uncache = 1),
            (s.getProp = o),
            (s.element = a),
    ...
    nv = (function () {
      ...
      return (
        ...
        (e.kill = function () {
          (this._killed = 1), this.clear(), delete Tl[this.id];
        }),
        t
      );
    })(),
