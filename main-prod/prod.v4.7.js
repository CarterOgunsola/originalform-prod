...
var yv = (zi, si, on) =>
  si in zi
    ? vv(zi, si, { enumerable: !0, configurable: !0, writable: !0, value: on })
    : (zi[si] = on);
var W = (zi, si, on) => yv(zi, typeof si != "symbol" ? si + "" : si, on);
(function () {
  "use strict";
...
` &&
  ...
  var s0 = class {
    ...
    advance(t) {
      ...
      if (this.duration && this.easing) {
        ...
        this.lerp
          ? ((this.value = n0(this.value, this.to, this.lerp * 60, t)),
  ...
  var o0 = class {
      constructor(t, e, { autoResize: i = !0, debounce: n = 250 } = {}) {
        ...
        (this.wrapper = t),
          (this.content = e),
          i &&
            ((this.debouncedResize = a0(this.resize, n)),
            this.wrapper instanceof Window
  ...
  const u0 = () => {
      "ontouchstart" in window ||
        navigator.maxTouchPoints > 0 ||
        ((ua = new c0({ autoRaf: !0, smoothWheel: !0, smoothTouch: !1 })),
   ...
   */ var pi,
    ...
    pa = function (e) {
      ...
      if (
        ...
        for (
          l = e.getAttribute("points").match(x0) || [],
   ...
   */ var D0 = 1,
    ...
    R0 = yl("onStart,onUpdate,onComplete,onReverseComplete,onInterrupt"),
    _a = yl(
    ...
    wa = function (e, i, n) {
      return (
        e.forEach(function (r) {
          return (r.d = B0(n ? r.element : r.t, i));
        }),
        e.sort(function (r, s) {
          return r.d - s.d;
        }),
    ...
    q0 = function (e) {
      ...
      return i || e.setAttribute("data-flip-id", (i = "auto-" + D0++)), i;
    },
    Zd = function (e) {
    ...
    Al = function (e, i, n) {
      if (e && e.progress() < 1 && (!e.paused() || n))
        return i && (V0(e), i < 2 && e.progress(1), e.kill()), !0;
    },
    Ta = function (e) {
      for (
        var i = (e.idLookup = {}),
    ...
    W0 = (function () {
      ...
      return (
        (e.add = function (n) {
          ...
          return r.length
            ? r[0]
            : ((r = new Y0(typeof n == "function" ? { animate: n } : n, this)),
              this.actions.push(r),
              r);
        }),
        (e.remove = function (n) {
    ...
    yr = (function () {
      ...
      return (
        ...
        (t.batch = function (i) {
          return i || (i = "default"), vl[i] || (vl[i] = new W0(i));
        }),
  ...
  const G0 = () => {
    ...
    X0 = () => {
      G0(), console.log("seoFlip");
    },
    j0 = () => {
      M0(), Zi(), nl(), Qi(), X0(), nc(), Mn().add(() => Ki(), "-=1");
    };
  R.registerPlugin(_e);
  const U0 = async (t) => {
      await document.fonts.ready;
  ...
  new ((function (t) {
    function e() {
      var n;
      return (
        ((n = t.call(this) || this).logger = new uv("@barba/core")),
        (n.all = [
          "ready",
          "page",
          "reset",
        ...
        if (this.registered.has(n)) {
          ...
          return (
            this.registered.get(n).forEach(function (o) {
              a = a.then(function () {
                return fv(o.fn, o.ctx).apply(void 0, [].slice.call(r, 1));
              });
            }),
            a.catch(function (o) {
