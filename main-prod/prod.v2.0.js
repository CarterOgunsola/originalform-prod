...
` &&
  ...
  const e0 = async () => {
      ...
      X.getAll().forEach((i) => {
        ...
        document.querySelectorAll("[split-text]").forEach((i) => {
          ye.create(i, {
            type: "lines",
            autoSplit: !0,
            mask: "lines",
            ...
            onSplit(n) {
              n.lines.forEach((o) => {
                ...
                l.setAttribute("data-line-wrapper", ""),
              ...
              const r = i.querySelectorAll("[data-line-wrapper]"),
                s = Array.from(r).map((o) => o.firstChild);
              R.set(s, { willChange: "transform" });
              const a = {
                trigger: i,
                start: "top 80%",
                end: "bottom top",
              ...
              return (
                t && ((a.refreshPriority = -99), (a.fastScrollEnd = !0)),
                R.from(s, {
                  yPercent: 120,
                  opacity: 0,
                  rotateZ: 2,
  ...
  const ul = () => {
    ...
    Qi = () => {
      ...
      const e = () => {
        clearTimeout(t),
          (t = setTimeout(() => {
            ll() || al(window.innerHeight) || X.refresh();
          }, 150));
      };
      return (
   ...
   */ var X0 = 1,
    ...
    U0 = Cl("onStart,onUpdate,onComplete,onReverseComplete,onInterrupt"),
    wa = Cl(
    ...
    Dl = function (e, i, n, r) {
      ...
      var s = n,
        ...
        te;
      for (G in i.idLookup)
        (fe = i.alt[G] ? of(i, e, G) : i.idLookup[G]),
          (Z = fe.element),
          ($e = e.idLookup[G]),
          e.alt[G] &&
            Z === $e.element &&
    ...
    yr = (function () {
      ...
      return (
        ...
        (t.batch = function (i) {
          return i || (i = "default"), El[i] || (El[i] = new nv(i));
        }),
  ...
  const vv = (t) => {
    ...
    yv = (t = !0) => {
      document.fonts.ready.then(() => {
        t ? cf() : uf(), window.addEventListener("resize", () => vv(t));
      });
    },
    bv = () => {
