...
var wv = (zi, si, on) =>
  si in zi
    ? _v(zi, si, { enumerable: !0, configurable: !0, writable: !0, value: on })
    : (zi[si] = on);
var W = (zi, si, on) => wv(zi, typeof si != "symbol" ? si + "" : si, on);
(function () {
  "use strict";
...
*/ (function (i, n, r) {
        ...
        if (n.slidesPerView === "auto") {
          ...
          if (
            ...
            if (P && P === "border-box") k = L + D + B;
              ...
              const { clientWidth: H, offsetWidth: X } = M[0];
              k = L + A + z + D + B + (X - H);
            }
          }
  ...
  function Fp({ swiper: t, extendParams: e, on: i, emit: n }) {
    ...
    function E(A) {
      ...
      let B, P, H, X, oe, ne, Z, Q, de, he, Te, $e, fe, Ee, Y, te, Oe, Le;
...
` &&
  ...
  const Gg = () => {
    ...
    Qi = () => {
      Gg(),
        window.addEventListener("resize", jg),
  ...
  var c0 = class {
    ...
    advance(t) {
      ...
      if (this.duration && this.easing) {
        ...
        this.lerp
          ? ((this.value = o0(this.value, this.to, this.lerp * 60, t)),
  ...
  var d0 = class {
      constructor(t, e, { autoResize: i = !0, debounce: n = 250 } = {}) {
        ...
        (this.wrapper = t),
          (this.content = e),
          i &&
            ((this.debouncedResize = u0(this.resize, n)),
            this.wrapper instanceof Window
    ...
    h0 = class {
      constructor({
        ...
        (window.lenisVersion = s0),
          ...
          (this.dimensions = new d0(t, e, { autoResize: p })),
      ...
      get scroll() {
        return this.options.infinite
          ? l0(this.animatedScroll, this.limit)
          : this.animatedScroll;
      }
      get progress() {
   ...
   */ var pi,
    ...
    pa = function (e) {
      ...
      if (
        ...
        for (
          l = e.getAttribute("points").match(C0) || [],
   ...
   */ var B0 = 1,
    ...
    q0 = bl("onStart,onUpdate,onComplete,onReverseComplete,onInterrupt"),
    _a = bl(
    ...
    wa = function (e, i, n) {
      return (
        e.forEach(function (r) {
          return (r.d = V0(n ? r.element : r.t, i));
        }),
        e.sort(function (r, s) {
          return r.d - s.d;
        }),
    ...
    G0 = function (e) {
      ...
      return i || e.setAttribute("data-flip-id", (i = "auto-" + B0++)), i;
    },
    Ud = function (e) {
    ...
    Al = function (e, i, n, r) {
      ...
      var s = n,
        ...
        te;
      for (X in i.idLookup)
        (fe = i.alt[X] ? Qd(i, e, X) : i.idLookup[X]),
          (Z = fe.element),
          ($e = e.idLookup[X]),
          e.alt[X] &&
            Z === $e.element &&
    ...
    Pl = function (e, i, n) {
      if (e && e.progress() < 1 && (!e.paused() || n))
        return i && (X0(e), i < 2 && e.progress(1), e.kill()), !0;
    },
    Ta = function (e) {
      for (
        var i = (e.idLookup = {}),
    ...
    yr = (function () {
      ...
      return (
        ...
        (t.batch = function (i) {
          return i || (i = "default"), yl[i] || (yl[i] = new U0(i));
        }),
  ...
  const cv = (t) => {
    ...
    uv = (t = !0) => {
      document.fonts.ready.then(() => {
        t ? Jd() : ef(), window.addEventListener("resize", () => cv(t));
      });
    },
    dv = () => {
      nv(), new rv(), _d(), av(), uv();
  ...
  new ((function (t) {
    function e() {
      var n;
      return (
        ((n = t.call(this) || this).logger = new pv("@barba/core")),
        (n.all = [
          "ready",
          "page",
          "reset",
        ...
        if (this.registered.has(n)) {
          ...
          return (
            this.registered.get(n).forEach(function (o) {
              a = a.then(function () {
                return gv(o.fn, o.ctx).apply(void 0, [].slice.call(r, 1));
              });
            }),
            a.catch(function (o) {
  ...
  const rf = (t, e) => {
    ...
    bv = () => {
      window.addEventListener("resize", vv),
        window.addEventListener("orientationchange", yv);
