  ...
  function Pa(t) {
    ...
    return (
      (Pa = function (n) {
        ...
        function r() {
          return ys(n, arguments, wr(this).constructor);
        }
        return (
      ...
      if (e)
        if (((e = (!e.name && e.default) || e), Ya() || e.headless)) {
          ...
          if ((Qn(), e !== r)) {
            if ($t[i]) return;
            Ot(r, Ot(Ms(e, s), a)),
              Xn(r.prototype, Xn(s, Ms(e, a))),
              ($t[(r.prop = i)] = r),
              e.targetTest && (As.push(r), (Za[i] = 1)),
              (i =
                (i === "css"
                  ? "CSS"
          ...
          wake: function () {
            cc &&
              (!Xa &&
                ...
                uc(Cs || li.GreenSockGlobals || (!li.gsap && li) || {}),
                Lc.forEach(zc)),
      ...
      return (
        ...
        (e.totalTime = function (n, r) {
          ...
          if (s && s.smoothChildTiming && this._ts) {
            for (
              zs(this, n), !s._dp || s.parent || wc(s, this);
              s && s.parent;
  ...
  var ht = (function (t) {
    ...
    return (
      ...
      (e.updateRoot = function (r) {
        if ((xe._ts && (mc(xe, Os(r, xe)), (fc = zt.frame)), zt.frame >= hc)) {
          hc += Pt.autoSleep || 120;
          var s = xe._first;
   ...
   */ var nt,
    ...
    gt = {
      ...
      sc: Vs(function (t) {
        return arguments.length
          ? Dt.scrollTo(t, Ve.sc())
          : Dt.pageXOffset || Wi[Fs] || Gi[Fs] || ir[Fs] || 0;
      }),
    },
    Ve = {
      s: qs,
      ...
      sc: Vs(function (t) {
        return arguments.length
          ? Dt.scrollTo(gt.sc(), t)
          : Dt.pageYOffset || Wi[qs] || Gi[qs] || ir[qs] || 0;
      }),
    },
    Ct = function (e, i) {
      return (
   ...
   */ var q,
    ...
    Fu = function (e) {
      return (
        ...
        (xn(e)
          ? function () {
              return (aa.width = se.innerWidth), (aa.height = No), aa;
            }
          : function () {
              return Ci(e);
            })
    ...
    U = (function () {
      ...
      return (
        (e.init = function (n, r) {
          ...
          n = Hu(Rt(n) || Qr(n) || n.nodeType ? { trigger: n } : n, Ks);
          var s = n,
            a = s.onUpdate,
            o = s.toggleClass,
            l = s.id,
            ...
            (P.refresh = function (F, K, X, J) {
              if (!((rt || !P.enabled) && !K)) {
                ...
                for (
                  D &&
                  Sn(X) &&
                  ((gs = q.getProperty(I, T.p)), (Aa = q.getProperty(ze, T.p)));
                  Ke-- > 0;
        ...
        (t.disable = function (n, r) {
          (Ur = 0),
            ...
            Zs(Xe, ve, "pointerup,touchend,mouseup", Iu),
            Hs.kill(),
            js(Xe);
          ...
          if (
            ...
            for (
              a.revert ||
                ...
                Zs(Ge, ve, "pointerup,touchend,mouseup", Iu),
                Lo = q.utils.checkPrefix("transform"),
                ra.push(Lo),
                rr = st(),
                Hs = q.delayedCall(0.2, Pn).pause(),
                sr = [
                  ve,
                  "visibilitychange",
                  function () {
        ...
        (t.config = function (n) {
          ...
          (r && clearInterval(Ys)) || ((Ys = r) && setInterval(Gu, r)),
   ...
   */ let as,
    ...
    ca = (t) =>
      typeof t == "string"
        ...
        ? Array.from(t)
        : [t],
    ld = (t) => ca(t).filter((e) => e instanceof HTMLElement),
    tl = [],
    il = function () {},
    Vg = /\s+/g,
    cd = new RegExp(
...
` &&
  ...
  const pd = class sf {
    ...
    static register(e) {
      (as = as || e || window.gsap),
        as && ((ca = as.utils.toArray), (il = as.core.context || il)),
        ...
        e.forEach((y) => {
          ...
          y.addEventListener("click", () => {
            v &&
              ...
              (o = !0),
              f(v),
              os().scrollTo(document.querySelector(`[service-item='${v}']`), {
                duration: 1.6,
                offset: -100,
              }),
              (l = setTimeout(() => {
   ...
   */ var Pi,
    ...
    I0 = function (e, i) {
      ...
      if (e === On) return e;
      if (
        (s.length || s.push(ml(e, 1), ml(e, 2), ml(e, 3)), (l = n ? ga : ls), n)
      )
        r
   ...
   */ var R0 = 1,
    ...
    Tl = function (e, i, n, r) {
      return e instanceof zn
        ...
        : e instanceof Kt
        ? V0(e, r)
        : new zn(typeof e == "string" ? ds(e) || void 0 : e, i, n);
    },
    H0 = function (e, i) {
      for (
    ...
    vr = (function () {
      ...
      return (
        ...
        (t.getByTarget = function (i) {
          return (ds(i) || ya)._flip;
        }),
        (t.getElementState = function (i, n) {
          return new zn(ds(i), n);
        }),
