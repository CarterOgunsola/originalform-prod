  ...
  const vv = new gv(),
    ...
    bv = () => {
      ...
      document.querySelectorAll("[nav-menu='close']"),
        document.querySelectorAll("[nav-brand-link='home']"),
        n.forEach((s) => {
          s.getAttribute("href").includes("#") ||
            (s.style.pointerEvents = "none");
        });
      const i = (s) => {
        ...
        s.parentNode.replaceChild(a, s),
          a.addEventListener("click", () => {
            const o = a.querySelectorAll("a");
            if (Array.from(o).some((c) => c.getAttribute("href") === t)) {
              const c = Qt == null ? void 0 : Qt();
              c && c.scrollTo(0, { duration: 1 });
            }
          });
      };
      r.forEach(i);
